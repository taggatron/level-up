...
gltfLoader.load(
    ...
    (gltf) => {
        ...
        model.position.set(1.5, 1, 0); // Adjusted to position along the side of the board
        scene.add(model);
    },
    undefined,
    function (error) {
...
fbxLoader.load(
    ...
    (fbx) => {
        ...
        fbx.position.set(-9.5, -1.5, -9.5); // Position the plant near the wall
...
function animate() {
    ...
    // Get camera coordinates and set the value in HTML element.
