...
const step2 = new THREE.Mesh(new THREE.BoxGeometry(2, 2.0, 1), boardMaterial);
const step3 = new THREE.Mesh(new THREE.BoxGeometry(2, 3.0, 1), boardMaterial);
...
step2.position.set(0, 1.0, 0.2); // Adjusted y position to align with table
